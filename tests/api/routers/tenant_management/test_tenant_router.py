...
class TestTenantRouter:
    ...
    def test_signup_public(self, client: TestClient):
        ...
        response = client.post("/tenants/signup", json=signup_data)
    ...
    def test_guest_cannot_list_tenants(
        self,
        client: TestClient,
        guest_token: str,
    ):
    ...
    def test_update_tenant_status_as_admin(
        self,
        client: TestClient,
        admin_token: str,
