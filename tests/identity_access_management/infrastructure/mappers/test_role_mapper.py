...
class TestRoleMapper:
    """
    Test suite for the RoleMapper.
    """

    def test_role_mapper_to_model(self):
        """
        Test mapping of a Role entity to a RoleModel.
        """
        role_id = uuid4()
        tenant_id = uuid4()
        entity = Role(
    ...
    def test_role_mapper_to_entity(self):
        """
        Test mapping of a RoleModel to a Role entity.
        """
        role_id = uuid4()
        tenant_id = uuid4()
