...
from src.core.application._shared.use_cases.queries import GetByIdRequestInputDTO
from src.core.application.use_cases.area import AreaNotFoundError
from src.core.application.use_cases.area.queries import GetAreaByIdUseCase
