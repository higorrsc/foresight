...
class TestInMemoryRepository:
    ...
    async def test_save_entity(self, default_tenant_id):
        """
        ...
        found_entity = await repository.get_by_id(
            entity_id=entity.id,
            tenant_id=default_tenant_id,
        )
        assert found_entity == entity

    async def test_get_by_id_found(self, default_tenant_id):
        """
    ...
    async def test_get_by_id_not_found(self, default_tenant_id):
        """
    ...
    async def test_get_all_entities(self, default_tenant_id):
        """
        ...
        entities = await repository.get_all(tenant_id=default_tenant_id)

        assert entities == [entity1, entity2]

    async def test_update_entity(self, default_tenant_id):
        """
    ...
    async def test_delete_entity(self, default_tenant_id):
        """
