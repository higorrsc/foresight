...
class TestTenantMapper:
    """
    Test suite for the TenantMapper.
    """

    def test_tenant_mapper_to_model(self):
        """
        Test mapping of a Tenant entity to a TenantModel.
        """
        tenant_id = uuid4()
        plan_id = uuid4()
        entity = Tenant(
    ...
    def test_tenant_mapper_to_entity(self):
        """
        Test mapping of a TenantModel to a Tenant entity.
        """
        tenant_id = uuid4()
        plan_id = uuid4()
        model = TenantModel(
