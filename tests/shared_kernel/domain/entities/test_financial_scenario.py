...
class TestFinancialScenarioEntity:
    """
    Test suite for the FinancialScenario entity.
    """

    def test_financial_scenario_creation(self):
        """
        Test that FinancialScenario initializes correctly with valid data.
        """
        tenant_id = uuid4()
    ...
    def test_financial_scenario_lock_unlock(self):
        """
        Test the lock and unlock methods of FinancialScenario.
        """
        scenario = FinancialScenario(
            id=uuid4(),
            tenant_id=uuid4(),
    ...
    def test_financial_scenario_validation_empty_description(self):
        """
        Test that creating a FinancialScenario with an
    ...
    def test_financial_scenario_validation_long_description(self):
        """
        Test that creating a FinancialScenario with a
