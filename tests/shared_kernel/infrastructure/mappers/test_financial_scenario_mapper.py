...
class TestFinancialScenarioMapper:
    """
    Test suite for the FinancialScenarioMapper.
    """

    def test_to_model(self):
        """
        Test mapping of a FinancialScenario entity to a FinancialScenarioModel.
        """
        tenant_id = uuid4()
        entity_id = uuid4()
    ...
    def test_to_entity(self):
        """
        Test mapping of a FinancialScenarioModel to a FinancialScenario entity.
        """
        tenant_id = uuid4()
        model_id = uuid4()
        created_by = uuid4()
