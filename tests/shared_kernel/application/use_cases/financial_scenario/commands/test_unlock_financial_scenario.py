...
def test_unlock_financial_scenario_success(admin_actor: User):
...
def test_unlock_financial_scenario_already_unlocked(admin_actor: User):
    repository = FinancialScenarioInMemoryRepository()
    scenario = FinancialScenario(
...
def test_unlock_financial_scenario_not_found(admin_actor: User):
    repository = FinancialScenarioInMemoryRepository()
    use_case = UnlockFinancialScenarioUseCase(repository)
